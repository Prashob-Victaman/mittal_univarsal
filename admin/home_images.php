...
<body onload="MM_CheckFlashVersion('7,0,0,0','Content on this page requires a newer version of Adobe Flash Player. Do you want to download it now?');">
    ...
    <div id="topmenu">
        ...
        <div id="top-panel">
            <div id="panel">
                <ul>
                    <li><a href="home.php" class="report">Manage Contents</a></li>
                    <li><a href="home_images.php" class="report"><strong>Manage Images</strong></a></li>
                </ul>
            </div>
      </div>
        <div id="wrapper">
            ...
            <div id="box">
                	<h3><strong>Home >> Images</strong></h3>
					...
					{ 
						...
						if(mysql_query($q))   
							print "<script>alert('Image deleted successfully!'); location='home_images.php';</script>";
						else 
						{ 
				...
				//Delete multiple User
					if(isset($_POST['action']) && $_POST['action']=="Delete")
					{
					  ...
					  echo "<script>alert('Image deleted successfully!'); location='home_images.php';</script>";
					}
				//Delete multiple User
...
// get the pager input values
  ...
  $rs = mysql_query("SELECT * FROM home_image $wer ORDER BY cr_date DESC LIMIT $offset, $limit");	
  
							if($total > 0) { 									
							while($rw = mysql_fetch_array($rs)) 
							{ 
								$title = (strlen($rw['title']) > 50) ? substr($rw['title'],0,50).".." : $rw['title'];
								$image = $rw['image'];	
                            ...
                            <tr>
                              ...
                              <td><a href="home_images.php?do=vedit&image_id=<?=$rw['image_id'];?>#ES"><?=$title;?></a></td>
                                <td><img src="image.php?src=<?=$image;?>&x=100&f=0" border=1 align="top"/></td>
                                                            
                              <td><?=$cr_date;?></td>
                                <td align="center">
                                 <a href="home_images.php?do=vedit&image_id=<?=$rw['image_id'];?>#ES">Edit</a> <b>&nbsp;|&nbsp;</b>
                                 <a href="javascript:;" onclick="_DelConfirm('home_images.php?do=del&image_id=<?=$rw['image_id'];?>');">Delete</a>                                 </td>
                            </tr>
							<? }  // end while
							} // end rec counf if
...
location = 'home_images.php?show='+_val;
<? } else { ?>
location = 'home_images.php?<?=$_SERVER['QUERY_STRING'];?>&show='+_val;
<? } ?> 
}
</script>
         ...
         <?php
						$u = (!empty($_GET['pid'])) ? 'home_images.php?pid='.$_GET['pid'].'&' : 'home_images.php?';
            ...
            <h3>Add New Image</h3>
                <form name="frmAddimages" id="form" action="" method="post" enctype="multipart/form-data" onsubmit="return __val(this);">
                      <fieldset id="personal">
                       ...
                       <br /><br /> 
                        ...
                        <input name="image" id="image" type="file" title="Upload Image" style="cursor:help"/>
                         <br />
                         <b style="margin-left:160px;">(Select only jpg, jpeg, gif, png images) </b>
                        <br /><br />
                  ...
                  <div align="center">
					...
					else print "<script>alert('Access Denied!!'); location = 'home_images.php';</script>";			
					  
					?>
                    <a name="ES"></a>
                    <div id="box">
            <h3>Update A Image</h3>
                <form name="frmEditimage" id="form" action="home_images.php" method="post" enctype="multipart/form-data" onsubmit="return __val(this)">
                      <fieldset id="personal">
                       ...
                       <br /><br />
                        ...
                        <div style="margin-left:160px;">
                         ...
                         <br />
                         <b>(Select only jpg, jpeg, gif, png images) </b>
                          <br />
                      ...
                      <div align="center">
                        ...
                        <input id="button2" type="button"  value="Cancel & Go Back" tabindex="11" onclick="location='home_images.php';" align="top"/>
                      </div>
                      </fieldset>
						...
						if($f2 == 1)
						 {
							...
							if(@mysql_query($update_q)) print "<script>alert('image updated successfully!'); location = 'home_images.php';</script>";
							else print "<script>alert('An error occured while processing your request!! Please try again later.'); location = 'home_images.php';</script>";
						 }
						 else
						 {
							 print "<font color='red'>You have tried invalied image files. Please select correct file!</font>";	
