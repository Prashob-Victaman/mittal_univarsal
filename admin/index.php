...
CKEDITOR.replace( 'pro_desc',
	...
	$(document).ready(function(){
			...
			$('.delete_btn').click(function(){
				...
				var floor =$(this).attr('data');
				var pid ='<?php echo $_GET['pid']; ?>';
				var image = $(this).attr('dat');
				//image=encodeURIComponent(image);
				//alert(image);
				$.post('delete.php',{req:'delete_image',floor:floor,pid:pid,image:image},function(data){
					//alert(data)
					if(data=='delete'){
                       ...
                       <fieldset>
                        ...
                        <input name="floor_plan" id="floor_plan" type="file"/>
							<?php if($floor_plan !='no-image' ){?>
								...
								<input class="delete_btn" type="button" data= "floor_plan" value="Delete" dat="<?php echo $floor_plan;?>" style="cursor:pointer">
								<?php } ?>
						...
						<?php if($floor_plan2!='no-image'){?>
							...
							<input class="delete_btn" type="button" data= "floor_plan2" value="Delete" dat="<?php echo $floor_plan2;?>" style="cursor:pointer">
							<?php }?>
						...
						<?php if($floor_plan3!='no-image') {?>
							...
							<input class="delete_btn" type="button" data= "floor_plan3" value="Delete" dat="<?php echo $floor_plan3;?>" style="cursor:pointer">
							<?php } ?>
						...
						<?php if($floor_plan4!='no-image'){?>
							<img src="image.php?src=<?=$floor_plan4;?>&x=100&f=0" border=1 align="top"/>        
								<input class="delete_btn" type="button" data= "floor_plan4" value="Delete" dat="<?php echo $floor_plan4;?>" style="cursor:pointer">
							<?php } ?>
						...
						<?php if($floor_plan5!='no-image') {?>
							<img src="image.php?src=<?=$floor_plan5;?>&x=100&f=0" border=1 align="top"/> 
							<input class="delete_btn" type="button" data= "floor_plan5" value="Delete" dat="<?php echo $floor_plan5;?>" style="cursor:pointer">
								<?php } ?>
						...
						<?php if($floor_plan6!='no-image'){?>
							...
							<input class="delete_btn" type="button" data= "floor_plan6"  value="Delete" dat="<?php echo $floor_plan6;?>" style="cursor:pointer">
							<?php } ?>
						...
						<?php if($floor_plan7!='no-image'){?>
							...
							<input class="delete_btn" type="button" data= "floor_plan7" value="Delete" dat="<?php echo $floor_plan7;?>" style="cursor:pointer">
							<?php } ?>
						...
						<input  class="delete_btn" type="button" data= "floor_plan8" value="Delete" dat="<?php echo $floor_plan8;?>" style="cursor:pointer">
						<?php } ?>
						...
						<?php if($map!='no-image'){?>
						 ...
						 <input  class="delete_btn" type="button" data= "map" value="Delete" dat="<?php echo $map;?>" style="cursor:pointer">
						 <?php } ?>
                        ...
                        <?php if($brochure != "no-image") {?>
							<a href="<?=$pdf_dir."/".$brochure;?>" target="_blank"/>View Ebrochure</a>  
								<input  class="delete_btn" type="button" data= "brochure" value="Delete" dat="<?php echo $brochure;?> " style="cursor:pointer">
                          <br />
				...
				$sql="Select floor_plan,floor_plan2,floor_plan3,floor_plan4,floor_plan5,floor_plan6,floor_plan7,floor_plan8, map, brochure from project where pid='".$_POST['pid']."'";
				$rs=mysql_query($sql);                      
