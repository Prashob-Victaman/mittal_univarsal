...
<?php 
$div_tab1 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Hospitality' AND sub_cat = 'Upcoming'  AND published = 'Y' AND city_id ='".$_REQUEST['id']."'");  
$rw_tab1 = mysql_fetch_array($div_tab1);
$div_tab2 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Hospitality' AND sub_cat = 'Ongoing'  AND published = 'Y' AND city_id ='".$_REQUEST['id']."'");  
$rw_tab2 = mysql_fetch_array($div_tab2);
$div_tab3 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Hospitality' AND sub_cat = 'Complete'  AND published = 'Y' AND city_id ='".$_REQUEST['id']."'");  
...
<?php 
$q_upc = mysql_query("select * from project where cat = 'Hospitality' and sub_cat = 'Upcoming' and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
...
?> 
    <li style="margin:0 0 8px 10px; padding:0 0 8px 0; background:url(../../images/doted-line.jpg) bottom repeat-x;"><a href="#" rel="view1_<?=$pid;?>"><?=$pro_name;?></a></li><br>
<?php 
}
?>    
</ul>
...
$q_ong = mysql_query("select * from project where cat = 'Hospitality' and sub_cat = 'Ongoing'  and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
...
$q_comp = mysql_query("select * from project where cat = 'Hospitality' and sub_cat = 'Complete'   and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
...
<?php
$q_upc_tabcon = mysql_query("select * from project where cat = 'Hospitality' and sub_cat = 'Upcoming'  and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
...
<?php
$q_ong_tabcon = mysql_query("select * from project where cat = 'Hospitality' and sub_cat = 'Ongoing'  and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
...
<?php
$q_comp_tabcon = mysql_query("select * from project where cat = 'Hospitality' and sub_cat = 'Complete'  and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
