...
<body>
	...
	<ul id="demo-block">
		<li><a href="index.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','img/small_screen_1.png',0)"><img src="img/small_screen.png" name="Image2" width="40" height="26" id="Image2" /></a></li>
	</ul>
