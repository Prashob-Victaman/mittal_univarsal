...
<?php 
$div_tab1 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Hospitality' AND sub_cat = 'Upcoming'  AND published = 'Y'");  
$rw_tab1 = mysql_fetch_array($div_tab1);
$div_tab2 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Hospitality' AND sub_cat = 'Ongoing'  AND published = 'Y'");  
$rw_tab2 = mysql_fetch_array($div_tab2);
$div_tab3 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Hospitality' AND sub_cat = 'Complete'  AND published = 'Y'");  
...
<div id="Pstab6"><a href="http://mittaluniversal.com/demo/index.html?tab=vision_and_mission" onMouseOut="bb2(); show_menu()" onMouseOver="aa2(); hide_menu()"><img src="../../images/vandm1.jpg" width="147" height="22" id="Image312" style="border:none;"></a></div>
...
<div id="tab5"><a href="http://mittaluniversal.com/demo/contact" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3636','','../../images/contact2.jpg',1)"><img src="../../images/contact1.jpg" width="90" height="22" id="Image3636" style="border:none;"></a></div>
  ...
  <div id="stab11">
  <a href="http://mittaluniversal.com/demo/project/commercial" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image27121','','../../images/commercial2.jpg',1)"><img src="../../images/commercial1.jpg" name="Image27121" width="108" height="22" id="Image27121" style="border:none;"></a>
  </div>
  ...
  <div id="stab8"><img src="../../images/hospitality2.jpg" name="Image2713" width="104" height="22" id="Image2713" style="border:none;"></div>
...
<?php 
$q_upc = mysql_query("select * from project where cat = 'Hospitality' and sub_cat = 'Upcoming' and published = 'Y'");
...
$q_ong = mysql_query("select * from project where cat = 'Hospitality' and sub_cat = 'Ongoing'  and published = 'Y'");
...
$q_comp = mysql_query("select * from project where cat = 'Hospitality' and sub_cat = 'Complete'   and published = 'Y'");
...
<?php
$q_upc_tabcon = mysql_query("select * from project where cat = 'Hospitality' and sub_cat = 'Upcoming'  and published = 'Y'");
...
<?php
$q_ong_tabcon = mysql_query("select * from project where cat = 'Hospitality' and sub_cat = 'Ongoing'  and published = 'Y'");
...
<?php
$q_comp_tabcon = mysql_query("select * from project where cat = 'Hospitality' and sub_cat = 'Complete'  and published = 'Y'");
