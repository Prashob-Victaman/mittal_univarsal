...
<?php 
$div_tab1 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Residential' AND sub_cat = 'Upcoming'  AND published = 'Y' AND city_id ='".$_REQUEST['id']."'");  
$rw_tab1 = mysql_fetch_array($div_tab1);
$div_tab2 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Residential' AND sub_cat = 'Ongoing'  AND published = 'Y' AND city_id ='".$_REQUEST['id']."'");  
$rw_tab2 = mysql_fetch_array($div_tab2);
$div_tab3 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Residential' AND sub_cat = 'Complete'  AND published = 'Y' AND city_id ='".$_REQUEST['id']."'");  
...
<script>
function uc() {
    $('.scroll-pane').jScrollPane({autoReinitialise: true, showArrows: true});
...
<div id="d_wrap">
  ...
  <div id="logo" style="position:fixed; z-index:10;"> <a href="http://skarma.com/clients/mittal"><img src="../../images/logo.png" width="263" height="96" style="padding:20px 0 0 20px; border:none"></a> </div>
 
  <div id="menu_my1">

   <ul class="dropdown">
        	<li><a href="http://skarma.com/clients/mittal">HOME</a></li>
        	<li><a href="http://skarma.com/clients/mittal/about">ABOUT</a></li>
        	...
        	<li><a href="http://skarma.com/clients/mittal/past_projects">PAST PROJECTS</a></li>
        	<li><a href="http://skarma.com/clients/mittal/social_activities">CSR</a></li>
            <li><a href="http://skarma.com/clients/mittal/contact">CONTACT</a></li>
        </ul>
  ...
  <div class="tabs_1234" id="wrapper">
...
<div class="scroll-pane" style="width:130px;">

<div id="view_all"><a href="http://skarma.com/clients/mittal/past_projects/">View all past projects</a></div>


<?php 
$q_upc = mysql_query("select * from project where cat = 'Residential' and sub_cat = 'Upcoming' and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
if(mysql_num_rows($q_upc) > 0)
{
?>

<div id="upcoming2">
<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image50','','../../images/upcoming2.jpg',0)" onClick="uc()">
<img src="../../images/upcoming1.jpg" name="Image50" width="104" height="27" id="Image50" style="border:none;"></a>
</div>

<div id="upcoming1"><img src="../../images/upcoming2.jpg" width="104" height="27"></div>
<div id="upcoming_sub">
...
?> 
    ...
    <li style="margin:-5px 0 8px 10px; padding:0 0 8px 0; background:url(../../images/doted-line.jpg) bottom repeat-x;"><a href="#" rel="view1_<?=$pid;?>"><?=$pro_name;?></a></li><br>
<?php 
}
?>    
</ul>
...
$q_ong = mysql_query("select * from project where cat = 'Residential' and sub_cat = 'Ongoing'  and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
if(mysql_num_rows($q_ong) > 0)
{
?>

<div id="ongoing1">
<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image47','','../../images/ongoing2.jpg',1)" onClick="og()">
<img src="../../images/ongoing1.jpg" name="Image47" width="104" height="27" id="Image47" style="border:none;"></a></div>

<div id="ongoing2"><img src="../../images/ongoing2.jpg" width="104" height="27"></div>
<div id="ongoing_sub" style="display:none">
  <ul class="tabs">
<?php
...
$q_comp = mysql_query("select * from project where cat = 'Residential' and sub_cat = 'Complete'   and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
if(mysql_num_rows($q_comp) > 0)
{
?>

<div id="complete1" style='display:block;'><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image444','','../../images/complete2.jpg',0)" onClick="co()"><img src="../../images/complete1.jpg" name="Image444" width="104" height="44" id="Image444" style="border:none;"></a></div>
<div id="complete2" style='display:none;'><img src="../../images/complete2.jpg" width="104" height="44"></div>
...
<?php
$q_upc_tabcon = mysql_query("select * from project where cat = 'Residential' and sub_cat = 'Upcoming'  and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
while($rw_upc_tabcon = mysql_fetch_array($q_upc_tabcon))
{
	...
	($rw_upc_tabcon['floor_plan6'] != 'no-image') ? $floor_plan6 = "../../admin/upload_images/".$rw_upc_tabcon['floor_plan6'] : $floor_plan6 = 'no-image';
	($rw_upc_tabcon['floor_plan7'] != 'no-image') ? $floor_plan7 = "../../admin/upload_images/".$rw_upc_tabcon['floor_plan7'] : $floor_plan7 = 'no-image';
	($rw_upc_tabcon['floor_plan8'] != 'no-image') ? $floor_plan8 = "../../admin/upload_images/".$rw_upc_tabcon['floor_plan8'] : $floor_plan8 = 'no-image';
...
<div class="scroll-pane">
  ...
  <div id="big_gallery"><a href="slide.php?pid=<?=$pid;?>&id=<?=$_REQUEST['id']?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4611','','../../images/small_screen_1.png',0)"><img src="../../images/small_screen.png" name="Image4611" width="40" height="26" id="Image4611" style="border:none;"></a></div>
  <div id="productprice_box1">
		...
		?>
              <img src="<?=$pro_image;?>" alt="" width="415" height="293" class="image8" title=""  style="border:none;">
  ...
  <?php }  if($floor_plan6 != 'no-image') { ?>
  <p style="display:none;"><a class="group4<?=$pid;?>"  href="<?=$floor_plan6;?>" title="">View Floor Plan6</a></p>
  <?php }  if($floor_plan7 != 'no-image') { ?>
  <p style="display:none;"><a class="group4<?=$pid;?>"  href="<?=$floor_plan7;?>" title="">View Floor Plan7</a></p>
  <?php }  if($floor_plan8 != 'no-image') { ?>
  <p style="display:none;"><a class="group4<?=$pid;?>"  href="<?=$floor_plan8;?>" title="">View Floor Plan8</a></p>
...
<?php
$q_ong_tabcon = mysql_query("select * from project where cat = 'Residential' and sub_cat = 'Ongoing'  and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
while($rw_ong_tabcon = mysql_fetch_array($q_ong_tabcon))
{
	...
	($rw_ong_tabcon['floor_plan6'] != 'no-image') ? $floor_plan6 = "../../admin/upload_images/".$rw_ong_tabcon['floor_plan6'] : $floor_plan6 = 'no-image';
	($rw_ong_tabcon['floor_plan7'] != 'no-image') ? $floor_plan7 = "../../admin/upload_images/".$rw_ong_tabcon['floor_plan7'] : $floor_plan7 = 'no-image';
	($rw_ong_tabcon['floor_plan8'] != 'no-image') ? $floor_plan8 = "../../admin/upload_images/".$rw_ong_tabcon['floor_plan8'] : $floor_plan8 = 'no-image';
...
<div class="scroll-pane">
  ...
  ?>
  <div id="overview_right2">
  <div id="big_gallery"><a href="slide.php?pid=<?=$pid;?>&id=<?=$_REQUEST['id']?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image46','','../../images/small_screen_1.png',0)"><img src="../../images/small_screen.png" name="Image46" width="40" height="26" id="Image46" style="border:none;"></a></div>
  <div id="productprice_box1">
  ...
  <?php }  if($floor_plan6 != 'no-image') { ?>
  <p style="display:none;"><a class="group_ogfp1<?=$pid;?>" href="<?=$floor_plan6;?>" title="">View Floor Plan6</a></p>
  <?php }  if($floor_plan7 != 'no-image') { ?>
  <p style="display:none;"><a class="group_ogfp1<?=$pid;?>" href="<?=$floor_plan7;?>" title="">View Floor Plan7</a></p>
  <?php }  if($floor_plan8 != 'no-image') { ?>
  <p style="display:none;"><a class="group_ogfp1<?=$pid;?>" href="<?=$floor_plan8;?>" title="">View Floor Plan8</a></p>
...
<?php
$q_comp_tabcon = mysql_query("select * from project where cat = 'Residential' and sub_cat = 'Complete'  and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
while($rw_comp_tabcon = mysql_fetch_array($q_comp_tabcon))
{
	...
	($rw_comp_tabcon['floor_plan6'] != 'no-image') ? $floor_plan6 = "../../admin/upload_images/".$rw_comp_tabcon['floor_plan6'] : $floor_plan6 = 'no-image';
	($rw_comp_tabcon['floor_plan7'] != 'no-image') ? $floor_plan7 = "../../admin/upload_images/".$rw_comp_tabcon['floor_plan7'] : $floor_plan7 = 'no-image';
	($rw_comp_tabcon['floor_plan8'] != 'no-image') ? $floor_plan8 = "../../admin/upload_images/".$rw_comp_tabcon['floor_plan8'] : $floor_plan8 = 'no-image';
...
<div class="scroll-pane">
  ...
  <?php }  if($floor_plan6 != 'no-image') { ?>
  <p style="display:none;"><a class="group_cofp1<?=$pid;?>" href="<?=$floor_plan6;?>" title="">View Floor Plan6</a></p>
  <?php }  if($floor_plan7 != 'no-image') { ?>
  <p style="display:none;"><a class="group_cofp1<?=$pid;?>" href="<?=$floor_plan7;?>" title="">View Floor Plan7</a></p>
  <?php }  if($floor_plan8 != 'no-image') { ?>
  <p style="display:none;"><a class="group_cofp1<?=$pid;?>" href="<?=$floor_plan8;?>" title="">View Floor Plan8</a></p>
...
<div id="footer_icon">
<div id="fb"><a href="https://www.facebook.com/pages/Mittal-Universal/444669482283502?skip_nax_wizard=true" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../images/fb2.png',1)"><img src="../../images/fb1.png" name="Image2" width="26" height="26" id="Image2" style="border:none"></a></div><div id="foot_devide" style="margin:0 6px 0 2px;"><img src="../../images/footer_devide.png" width="2" height="26"></div>
