...
{
	$ongoing1_display = 'style="display:none"';
	$ongoing2_display = 'style="display:block"';
	if(isset($pid) && $pid)
	{
		$ongoing1_display = 'style="display:block"';
		$ongoing2_display ='style="display:none"';
	} 
?>
<div id="ongoing1" <?php echo $ongoing1_display; ?>>
...
<div id="ongoing2" <?php echo $ongoing2_display; ?> ><img src="../../images/ongoing2.jpg" width="104" height="27"></div>

<div id="ongoing_sub" <?php echo $ongoing2_display; ?>>
  <ul class="tabs">
<?php
...
<div class="scroll-pane">
  ...
  <div id="productprice_box1">
		...
		?>
            <li>
              <img src="<?=$pro_image;?>" alt="" class="image8 proj_image_pos" title=""  style="border:none;">
            </li>
