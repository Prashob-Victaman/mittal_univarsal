...
<div class="scroll-pane">
  ...
  <div id="big_gallery" class="gallery_btn" ><a data="<?php echo $pid; ?>"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4611','','../../images/small_screen_1.png',0)"><img src="../../images/small_screen.png" name="Image4611" width="40" height="26" id="Image4611" style="border:none;"></a></div>
...
$cou=mysql_num_rows($q_ong_tabcon);
//echo $cou;
...
<div id="light_box" style = "width:100%;height:200px;display:none" >
<?php $sql="select * from image where pid = $pid order by image_id"; 
...
<ul id="fancy_box" >
<?php while($row=mysql_fetch_array($result)){ ?>
<li ><a rel="example_group" href="../../admin/upload_images/<?php echo $row['image'] ; ?>" ><img src="../../admin/upload_images/<?php echo $row['image'] ; ?>" ></a></li>
<?php }?>
</ul>
