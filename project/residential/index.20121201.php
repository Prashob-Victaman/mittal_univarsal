...
<?php 
$div_tab1 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Residential' AND sub_cat = 'Upcoming'  AND published = 'Y'");  
$rw_tab1 = mysql_fetch_array($div_tab1);
$div_tab2 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Residential' AND sub_cat = 'Ongoing'  AND published = 'Y'");  
$rw_tab2 = mysql_fetch_array($div_tab2);
$div_tab3 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Residential' AND sub_cat = 'Complete'  AND published = 'Y'");  
...
<div id="tab5"><a href="http://mittaluniversal.com/demo/contact" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3636','','../../images/contact2.jpg',1)"><img src="../../images/contact1.jpg" width="90" height="22" id="Image3636" style="border:none;"></a></div>
  ...
  <div id="stab7"><img src="../../images/residential2.jpg" name="Image2712" width="106" height="22" id="Image2712" style="border:none;"></div>
...
<?php 
$q_upc = mysql_query("select * from project where cat = 'Residential' and sub_cat = 'Upcoming' and published = 'Y'");
...
$q_ong = mysql_query("select * from project where cat = 'Residential' and sub_cat = 'Ongoing'  and published = 'Y'");
...
$q_comp = mysql_query("select * from project where cat = 'Residential' and sub_cat = 'Complete'   and published = 'Y'");
...
<?php
$q_upc_tabcon = mysql_query("select * from project where cat = 'Residential' and sub_cat = 'Upcoming'  and published = 'Y'");
...
<?php
$q_ong_tabcon = mysql_query("select * from project where cat = 'Residential' and sub_cat = 'Ongoing'  and published = 'Y'");
...
<?php
$q_comp_tabcon = mysql_query("select * from project where cat = 'Residential' and sub_cat = 'Complete'  and published = 'Y'");
