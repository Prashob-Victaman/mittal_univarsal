...
<div id="view11_<?=$pid;?>" class="tabcontent1 h355">
<div id="overview_left2a">
<div class="scroll-pane">
      <p style="margin:0px; padding:0px;">
  ...
  <?php } if($map != 'no-image') { ?>
	<div id="project_bottom_btn_new"> <a class="group_ogm1<?=$pid;?> view_look cboxElement"  href="<?=$map;?>" title="">View Map</a></div>
  ...
  <div id="project_bottom_btn_new"> 
  <?php if($floor_plan != 'no-image') { ?>
  <a class="group_ogfp1<?=$pid;?> cboxElement"  href="<?=$floor_plan;?>" title="">View Floor Plan</a>
  <?php }  if($floor_plan2 != 'no-image') { ?>
  <p style="display:none;"><a class="group_ogfp1<?=$pid;?> cboxElement" href="<?=$floor_plan2;?>" title="">View Floor Plan2</a></p>
  <?php }  if($floor_plan3 != 'no-image') { ?>
  <p style="display:none;"><a class="group_ogfp1<?=$pid;?> cboxElement" href="<?=$floor_plan3;?>" title="">View Floor Plan3</a></p>
  <?php }  if($floor_plan4 != 'no-image') { ?>
  <p style="display:none;"><a class="group_ogfp1<?=$pid;?> cboxElement" href="<?=$floor_plan4;?>" title="">View Floor Plan4</a></p>
  <?php }  if($floor_plan5 != 'no-image') { ?>
  <p style="display:none;"><a class="group_ogfp1<?=$pid;?> cboxElement" href="<?=$floor_plan5;?>" title="">View Floor Plan5</a></p>
  <?php }?>
	</div></div>
 </div>
<div class="fancybox" style="display:none;" >
 ...
 $(".cboxElement").colorbox({rel:'group_ogfp1<?=$pid;?>', slideshow:false});
  });
 </script>
<?php 
}    //End While
