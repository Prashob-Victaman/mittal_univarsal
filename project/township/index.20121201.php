...
<?php 
$div_tab1 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Township' AND sub_cat = 'Upcoming'  AND published = 'Y'");  
$rw_tab1 = mysql_fetch_array($div_tab1);
$div_tab2 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Township' AND sub_cat = 'Ongoing'  AND published = 'Y'");  
$rw_tab2 = mysql_fetch_array($div_tab2);
$div_tab3 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Township' AND sub_cat = 'Complete'  AND published = 'Y'");  
...
<?php 
$q_upc = mysql_query("select * from project where cat = 'Township' and sub_cat = 'Upcoming' and published = 'Y'");
...
$q_ong = mysql_query("select * from project where cat = 'Township' and sub_cat = 'Ongoing'  and published = 'Y'");
...
$q_comp = mysql_query("select * from project where cat = 'Township' and sub_cat = 'Complete' and published = 'Y'");
...
<?php
$q_upc_tabcon = mysql_query("select * from project where cat = 'Township' and sub_cat = 'Upcoming' and published = 'Y'");
...
<?php
$q_ong_tabcon = mysql_query("select * from project where cat = 'Township' and sub_cat = 'Ongoing'  and published = 'Y'");
...
<?php
$q_comp_tabcon = mysql_query("select * from project where cat = 'Township' and sub_cat = 'Complete'  and published = 'Y'");
