...
<ul class="menu2" id="menu3"><li><div id="tab2">
<a href="http://skarma.com/clients/mittal/about/" onMouseOut="MM_swapImgRestore(); show_menu()" class="menulink" onMouseOver="MM_swapImage('Image9','','../../images/about2.jpg',1); hide_menu()"><img src="../../images/about1.jpg" name="Image9" width="70" height="22" id="Image9" style="border:none;"></a>

<ul style="position:absolute;  margin:0 0 0 -543px;">
<li style="width:612px;">

<div id="Pstab5"><a href="http://skarma.com/clients/mittal/about/index.html?tab=overview" onMouseOut="bb1(); show_menu()" onMouseOver="aa1(); hide_menu()"><img src="../../images/overview1.jpg" width="103" height="22" id="Image311" style="border:none;"></a></div>

<div id="devider2" onMouseOver="hide_menu()" onMouseOut="show_menu()"><img src="../../images/devider2.jpg" width="1" height="22"></div>

<div id="Pstab6"><a href="http://skarma.com/clients/mittal/about/index.html?tab=vision_and_mission" onMouseOut="bb2(); show_menu()" onMouseOver="aa2(); hide_menu()"><img src="../../images/vandm1.jpg" width="147" height="22" id="Image312" style="border:none;"></a></div>

<div id="devider2" onMouseOver="hide_menu()" onMouseOut="show_menu()"><img src="../../images/devider2.jpg" width="1" height="22"></div>

<div id="Pstab7"><a href="http://skarma.com/clients/mittal/about/index.html?tab=history" onMouseOut="bb3(); show_menu()" onMouseOver="aa3(); hide_menu()"><img src="../../images/history1.jpg" width="94" height="22" id="Image313" style="border:none;"></a></div>

<div id="devider2" onMouseOver="hide_menu()" onMouseOut="show_menu()"><img src="../../images/devider2.jpg" width="1" height="22"></div>

<div id="Pstab8"><a href="http://skarma.com/clients/mittal/about/index.html?tab=the_brand" onMouseOut="bb4(); show_menu()" onMouseOver="aa4(); hide_menu()"><img src="../../images/brand1.jpg" width="114" height="22" id="Image314" style="border:none;"></a></div>

<div id="devider2" onMouseOver="hide_menu()" onMouseOut="show_menu()"><img src="../../images/devider2.jpg" width="1" height="22"></div>

<div id="Pstab9"><a href="http://skarma.com/clients/mittal/about/index.html?tab=social" onMouseOut="bb5(); show_menu()" onMouseOver="aa5(); hide_menu()"><img src="../../images/social1.jpg" width="150" height="22" id="Image315" style="border:none;"></a></div>
</li>
</ul>
</div>
...
<div id="tab5"><a href="http://skarma.com/clients/mittal/contact" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3636','','../../images/contact2.jpg',1)"><img src="../../images/contact1.jpg" width="90" height="22" id="Image3636" style="border:none;"></a></div>
  ...
  <div id="clear"></div>
  <div id="sub_tab_main2a" onMouseOver="toggleDiv('sub_tab_main1',1)" onMouseOut="toggleDiv('sub_tab_main1a',0)">
  
  <div id="stab11">
  <a href="http://skarma.com/clients/mittal/project/commercial" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image27121','','../../images/commercial2.jpg',1)"><img src="../../images/commercial1.jpg" name="Image27121" width="108" height="22" id="Image27121" style="border:none;"></a>
  </div>
  
  <div id="devider2"><img src="../../images/devider2.jpg" width="1" height="22"></div>
  
  <div id="stab7"><a href="http://skarma.com/clients/mittal/project/residential" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2712','','../../images/residential2.jpg',1)"><img src="../../images/residential1.jpg" name="Image2712" width="106" height="22" id="Image2712" style="border:none;"></a></div>
  
  <div id="devider2"><img src="../../images/devider2.jpg" width="1" height="22"></div>
  
  <div id="stab8"><a href="http://skarma.com/clients/mittal/project/hospitality" class="panel" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2713','','../../images/hospitality2.jpg',1)"><img src="../../images/hospitality1.jpg" name="Image2713" width="104" height="22" id="Image2713" style="border:none;"></a></div>
  
  <div id="devider2"><img src="../../images/devider2.jpg" width="1" height="22"></div>
  
  <div id="stab9"><img src="../../images/township2.jpg" name="Image2714" width="93" height="22" id="Image2714" style="border:none;"></div>
  </div>
...
<?php
$q_upc = mysql_query("select * from project where cat = 'Township' and sub_cat = 'Upcoming'");
...
<div id="ongoing_sub">
  <ul class="tabs">
<?php
$q_ong = mysql_query("select * from project where cat = 'Township' and sub_cat = 'Ongoing'");
...
<div id="complete1"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image444','','../../images/complete2.jpg',0)" onClick="co()"><img src="../../images/complete1.jpg" name="Image444" width="104" height="27" id="Image444" style="border:none;"></a></div>
<div id="complete2"><img src="../../images/complete2.jpg" width="104" height="27"></div>
<div id="complete_sub">
  <ul class="tabs">
<?php
$q_comp = mysql_query("select * from project where cat = 'Township' and sub_cat = 'Complete'");
...
<?php
$q_upc_tabcon = mysql_query("select * from project where cat = 'Township' and sub_cat = 'Upcoming'");
...
<div class="scroll-pane">
  ...
  <div id="big_gallery"><a href="slide.php?pid=<?=$pid;?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4611','','../../images/small_screen_1.png',0)"><img src="../../images/small_screen.png" name="Image4611" width="40" height="26" id="Image46" style="border:none;"></a></div>
...
<?php
$q_ong_tabcon = mysql_query("select * from project where cat = 'Township' and sub_cat = 'Ongoing'");
...
<?php
$q_comp_tabcon = mysql_query("select * from project where cat = 'Township' and sub_cat = 'Complete'");
