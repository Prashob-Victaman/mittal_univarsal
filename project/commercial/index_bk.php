...
<?php 
$div_tab1 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Commercial' AND sub_cat = 'Upcoming'  AND published = 'Y' AND city_id ='".$_REQUEST['id']."'");  
$rw_tab1 = mysql_fetch_array($div_tab1);
$div_tab2 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Commercial' AND sub_cat = 'Ongoing'  AND published = 'Y' AND city_id ='".$_REQUEST['id']."'");  
$rw_tab2 = mysql_fetch_array($div_tab2);
$div_tab3 = mysql_query("SELECT COUNT(*) FROM project WHERE cat = 'Commercial' AND sub_cat = 'Complete'  AND published = 'Y' AND city_id ='".$_REQUEST['id']."'");  
...
<?php 
$e=0;
$q_upc = mysql_query("select * from project where cat = 'Commercial' and sub_cat = 'Upcoming' and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
...
<img src="../../images/upcoming1.jpg" name="Image50" width="104" height="27" id="Image50" style="border:none;"></a></div>
...
$q_ong = mysql_query("select * from project where cat = 'Commercial' and sub_cat = 'Ongoing'  and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
...
$q_comp = mysql_query("select * from project where cat = 'Commercial' and sub_cat = 'Complete'   and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
if(mysql_num_rows($q_comp) > 0)
{
if($e==0){
echo '<script type="text/javascript">co();</script>';
$e = $e + 1;
}
?>
...
<div id="complete_sub" style="display: block;">
  <ul class="tabs">
<?php
...
<?php
$q_upc_tabcon = mysql_query("select * from project where cat = 'Commercial' and sub_cat = 'Upcoming'  and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
...
<div class="scroll-pane">
  ...
  <div id="big_gallery"><a href="slide.php?pid=<?=$pid;?>&id=<?=$_REQUEST['id']?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4611','','../../images/small_screen_1.png',0)"><img src="../../images/small_screen.png" name="Image46" width="40" height="26" id="Image4611" style="border:none;"></a></div>
...
<?php
$q_ong_tabcon = mysql_query("select * from project where cat = 'Commercial' and sub_cat = 'Ongoing'  and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
...
<div class="scroll-pane">
      ...
      <!--<div style="float:left; width:100%; height:auto;" class="black16_d"></div><br>-->
      <div style="float:left; width:100%; height:auto; margin:0 0 10px 0;" class="black16a_d"><?=strtoupper($pro_area);?></div>
      <div style="float:left; width:100%; height:auto; padding:0 0 15px 0;" class="grey13">
      <?=$pro_desc;?>
    </div>
...
<?php
$q_comp_tabcon = mysql_query("select * from project where cat = 'Commercial' and sub_cat = 'Complete'  and published = 'Y' AND city_id ='".$_REQUEST['id']."'");
...
<div class="scroll-pane">
  ...
  <?php } if($map != 'no-image') { ?>
  <div id="project_bottom_btn_new"> <a class="group_com2<?=$pid;?>"  href="<?=$map;?>" title="">View Map</a></div>
